...
export default function Questionario() {
  ...
  const handleTerceiroSetor = useCallback((e) => set('terceiro_setor', e.target.value), [set]);
            ...
            <div className="card-etapa" onKeyDown={bloquearEnter}>
              ...
              {etapa === 2 && (
                <>
                  ...
                  <CampoTextarea id="terceiro_setor" label="Ja atuou no terceiro setor? Descreva o que fez."
                    erro={erros.terceiro_setor} value={dados.terceiro_setor} onChange={handleTerceiroSetor}
                    placeholder="Ex: ONG, associacao, fundacao — descreva as atividades realizadas..." />
                </>
              )}
